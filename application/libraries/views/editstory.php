...
<form  action="/story/update" method="post">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="col-xs-12 editlabeltext">Reason to be Volunteer</div>
        </div>
    ...
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-1">
            <div class="col-xs-12 editlabeltext">Action</div>
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-4">
            <div class="col-xs-12 editlabeltext">Text</div>
        </div>
        <div class="col-md-4"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-1">
            <div class="col-xs-12 editlabeltext">Post Time</div>
        </div>
        <div class="col-md-4">
